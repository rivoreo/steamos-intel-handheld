...
const GamePowerPanel = () => {
    ...
    const candidates = (runtime?.auto_target?.candidates ?? []).filter((fps) => fps >= supportedMin && fps <= supportedMax);
